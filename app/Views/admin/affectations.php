...
<main class="flex min-h-screen bg-gray-100">
    ...
    <div class="flex-1 p-8">
        ...
        <h2 class="text-2xl font-bold mb-4 text-gray-800">Liste des affectations</h2>
            ...
            <table class="min-w-full leading-normal">
                <thead>
                    <tr>
                        ...
                        <th colspan="2" class="px-5 py-3 border-b-2 border-gray-200 bg-gray-200 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Professeur</th>
                    </tr>
                </thead>
                <tbody>
